...
#define GENERIC_INIT(INN, NFM)                                                 \
  ...
  const int Nfp = (INN + 1);                                                   \
  const int Nfaces = 4;                                                        \
  BFAM_WARNING("using generic NFM for 2d of order %d with "                    \
...
#define GENERIC_INIT(INN, NFM)                                                 \
  ...
  const int Nfaces = 6;                                                        \
  BFAM_WARNING("using generic NFM for 3d of order %d with "                    \
               "Np = %d, Nfp = %d, and Nfaces = %d",                           \
               N, Np, Nfp, Nfaces);
#else
#define GENERIC_INIT(INN, NFM) BFAM_NOOP()
...
#define beard_dgx_inter_rhs_slip_weakening_interface                           \
  BEARD_APPEND_EXPAND_4(beard_dgx_inter_rhs_slip_weakening_interface_, DIM, _, \
                        NORDER)

#define beard_dgx_inter_rhs_ageing_law_interface                               \
  BEARD_APPEND_EXPAND_4(beard_dgx_inter_rhs_ageing_law_interface_, DIM, _,     \
                        NORDER)
...
static inline void beard_dgx_upwind_state_friction_m(
    bfam_real_t *TpS, bfam_real_t *vpSm, bfam_real_t *VpS, const bfam_real_t T,
...
static inline bfam_locidx_t beard_dgx_rs_arcsinh_newton(
    bfam_real_t *V_ptr, bfam_real_t *T_ptr, const bfam_real_t eta,
    const bfam_real_t phi, const bfam_real_t a, const bfam_real_t psi,
    const bfam_real_t Tn, const bfam_real_t V0,
    const bfam_locidx_t max_iterations, const bfam_real_t ftol,
    const bfam_real_t atol, const bfam_real_t rtol)
{
  ...
  {
    const bfam_real_t dG =
        -eta + Tn * a * A / BFAM_REAL_SQRT(A * A * V * V + 1);
    bfam_real_t dV = -G / dG;
    V += dV;
    ...
    if (BFAM_REAL_ABS(G) < ftol * (1 + G2) ||
        (BFAM_REAL_ABS(dV) <=
         atol + rtol * (BFAM_REAL_ABS(V) + BFAM_REAL_ABS(dV))))
    {
      *V_ptr = V;
      *T_ptr = -Tn * a * BFAM_REAL_ASINH(A * V);
...
static inline void beard_dgx_upwind_state_m(
    bfam_real_t *Tns, bfam_real_t *TpS, bfam_real_t *vns, bfam_real_t *vps,
    bfam_real_t Tnm, bfam_real_t Tnp, const bfam_real_t *Tpm,
    const bfam_real_t *Tpp, const bfam_real_t vnm, const bfam_real_t vnp,
    const bfam_real_t *vpm, const bfam_real_t *vpp, const bfam_real_t Zpm,
    const bfam_real_t Zpp, const bfam_real_t Zsm, const bfam_real_t Zsp)
{
...
static inline void beard_dgx_central_state_m(
    bfam_real_t *Tns, bfam_real_t *TpS, bfam_real_t *vns, bfam_real_t *vps,
    const bfam_real_t Tnm, const bfam_real_t Tnp, const bfam_real_t *Tpm,
    const bfam_real_t *Tpp, const bfam_real_t vnm, const bfam_real_t vnp,
    const bfam_real_t *vpm, const bfam_real_t *vpp, const bfam_real_t Zpm,
    const bfam_real_t Zpp, const bfam_real_t Zsm, const bfam_real_t Zsp)
{
...
static inline void beard_dgx_add_flux(
    const bfam_real_t scale, const bfam_real_t delta_TnS,
    const bfam_real_t *delta_TpS, const bfam_real_t vnS, const bfam_real_t *vpS,
    const bfam_locidx_t iM, bfam_real_t *dv1, bfam_real_t *dv2,
    bfam_real_t *dv3, bfam_real_t *dS11, bfam_real_t *dS22, bfam_real_t *dS33,
    bfam_real_t *dS12, bfam_real_t *dS13, bfam_real_t *dS23,
    const bfam_real_t lam, const bfam_real_t mu, const bfam_real_t rhoi,
    const bfam_real_t *nm, const bfam_real_t sJ, const bfam_real_t JI,
    const bfam_real_t wi)
{

  /* velocities for the flux */
  bfam_real_t vS[] = {vpS[0] + nm[0] * vnS, vpS[1] + nm[1] * vnS,
  ...
  dS11[iM] += JI_wi_sJ * BEARD_D3_AP(M * vS[0] * nm[0] + lam * vS[1] * nm[1],
                                     +lam * vS[2] * nm[2]);
  dS22[iM] += JI_wi_sJ * BEARD_D3_AP(lam * vS[0] * nm[0] + M * vS[1] * nm[1],
                                     +lam * vS[2] * nm[2]);
  dS33[iM] += JI_wi_sJ * BEARD_D3_AP(lam * vS[0] * nm[0] + lam * vS[1] * nm[1],
                                     +M * vS[2] * nm[2]);
...
static inline void beard_dgx_remove_flux(
    const int inN, bfam_locidx_t face, bfam_locidx_t e,
    const bfam_locidx_t *vmapM, const bfam_real_t *n1, const bfam_real_t *n2,
#if DIM == 3
    const bfam_real_t *n3,
#endif
    const bfam_real_t *Zs, const bfam_real_t *Zp, const bfam_real_t *mu,
    const bfam_real_t *rhoi, const bfam_real_t *lam, const bfam_real_t *sJ,
    const bfam_real_t *JI, const bfam_real_t *wi, const bfam_real_t *v1,
    const bfam_real_t *v2, const bfam_real_t *v3, const bfam_real_t *S11,
    const bfam_real_t *S22, const bfam_real_t *S33, const bfam_real_t *S12,
    ...
    bfam_real_t *dS33, bfam_real_t *dS12, bfam_real_t *dS13, bfam_real_t *dS23)
{
  ...
  for (bfam_locidx_t pnt = 0; pnt < Nfp; pnt++)
  {
    ...
    const bfam_real_t TnM =
        BEARD_D3_AP(TpM[0] * nM[0] + TpM[1] * nM[1], +TpM[2] * nM[2]);
    TpM[0] = TpM[0] - TnM * nM[0];
    TpM[1] = TpM[1] - TnM * nM[1];
    BEARD_D3_OP(TpM[2] = TpM[2] - TnM * nM[2]);

    bfam_real_t vpM[] = {v1[iM], v2[iM], v3[iM]};
    const bfam_real_t vnM =
        BEARD_D3_AP(nM[0] * vpM[0] + nM[1] * vpM[1], +nM[2] * vpM[2]);
    ...
    beard_dgx_add_flux(-1, TnS, TpS, vnS, vpS, iM, dv1, dv2, dv3, dS11, dS22,
                       dS33, dS12, dS13, dS23, lam[iM], mu[iM], rhoi[iM], nM,
                       sJ[f], JI[iM], wi[0]);
  }
}

static inline void beard_dgx_add_boundary_flux(
    const int inN, bfam_locidx_t face, bfam_locidx_t e,
    const bfam_locidx_t *vmapM, const bfam_real_t *n1, const bfam_real_t *n2,
#if DIM == 3
    const bfam_real_t *n3,
...
static inline void
beard_project_flux(bfam_real_t *Tns, bfam_real_t *TpS, bfam_real_t *vns,
                   bfam_real_t *vps, bfam_locidx_t inN, bfam_locidx_t Nrpg,
      ...
      for (int j = 0, n = 0; j < N + 1; j++)
...
#endif
        {
          const bfam_real_t PR =
              BEARD_D3_AP(P1[j + m * (N + 1)], *P2[i + l * (N + 1)]);
          for (int k = 0; k < 3; k++)
          {
...
static inline void
beard_massproject_flux(bfam_real_t *Tns, bfam_real_t *TpS, bfam_real_t *vns,
                       bfam_real_t *vps, bfam_locidx_t inN, bfam_locidx_t Nrpg,
                       const bfam_real_t *Tng, const bfam_real_t *Tpg,
                       const bfam_real_t *vng, const bfam_real_t *vpg,
...
void beard_dgx_rupture_time(int inN, bfam_subdomain_dgx_t *sub,
...
void beard_dgx_duvaut_lions_return_map(int inN, bfam_subdomain_dgx_t *sub,
                                       ...
                                       const bfam_long_real_t dt)
{
  ...
  for (bfam_locidx_t e = 0; e < K; e++)
  {
    ...
    for (bfam_locidx_t i = 0; i < Np; i++)
    {
      ...
      const bfam_real_t Y =
          BFAM_MAX(0, c[k] * BFAM_REAL_COS(phi[k]) -
      ...
      {
        const bfam_real_t r =
            BFAM_REAL_EXP(-(bfam_real_t)dt / Tr[k]) +
...
void beard_dgx_intra_rhs_elastic(int inN, bfam_subdomain_dgx_t *sub,
                                 ...
                                 const bfam_long_real_t t)
{
  ...
  BEARD_D3_OP(
      BFAM_LOAD_FIELD_RESTRICT_ALIGNED(Jr1x3, "", "_grid_Jr0x2", fields));
  BFAM_LOAD_FIELD_RESTRICT_ALIGNED(Jr2x1, "", "_grid_Jr1x0", fields);
  BFAM_LOAD_FIELD_RESTRICT_ALIGNED(Jr2x2, "", "_grid_Jr1x1", fields);
  BEARD_D3_OP(
      BFAM_LOAD_FIELD_RESTRICT_ALIGNED(Jr2x3, "", "_grid_Jr1x2", fields));

  BEARD_D3_OP(
      BFAM_LOAD_FIELD_RESTRICT_ALIGNED(Jr3x1, "", "_grid_Jr2x0", fields));
  BEARD_D3_OP(
      BFAM_LOAD_FIELD_RESTRICT_ALIGNED(Jr3x2, "", "_grid_Jr2x1", fields));
  BEARD_D3_OP(
      BFAM_LOAD_FIELD_RESTRICT_ALIGNED(Jr3x3, "", "_grid_Jr2x2", fields));
  ...
  for (bfam_locidx_t e = 0; e < K; e++)
  {
    ...
    for (bfam_locidx_t i = 0; i < Np; i++)
    {
      aux1[i] = BEARD_D3_AP(Jr1x1[off + i] * S11[off + i] +
                                Jr1x2[off + i] * S12[off + i],
                            +Jr1x3[off + i] * S13[off + i]);
      aux2[i] = BEARD_D3_AP(Jr2x1[off + i] * S11[off + i] +
                                Jr2x2[off + i] * S12[off + i],
                            +Jr2x3[off + i] * S13[off + i]);
      BEARD_D3_OP(aux3[i] = Jr3x1[off + i] * S11[off + i] +
                            Jr3x2[off + i] * S12[off + i] +
    ...
    for (bfam_locidx_t i = 0; i < Np; i++)
    {
      aux1[i] = BEARD_D3_AP(Jr1x1[off + i] * S12[off + i] +
                                Jr1x2[off + i] * S22[off + i],
                            +Jr1x3[off + i] * S23[off + i]);
      aux2[i] = BEARD_D3_AP(Jr2x1[off + i] * S12[off + i] +
                                Jr2x2[off + i] * S22[off + i],
                            +Jr2x3[off + i] * S23[off + i]);
      BEARD_D3_OP(aux3[i] = Jr3x1[off + i] * S12[off + i] +
                            Jr3x2[off + i] * S22[off + i] +
    ...
    for (bfam_locidx_t i = 0; i < Np; i++)
    {
      aux1[i] = BEARD_D3_AP(Jr1x1[off + i] * S13[off + i] +
                                Jr1x2[off + i] * S23[off + i],
                            +Jr1x3[off + i] * S33[off + i]);
      aux2[i] = BEARD_D3_AP(Jr2x1[off + i] * S13[off + i] +
                                Jr2x2[off + i] * S23[off + i],
                            +Jr2x3[off + i] * S33[off + i]);
      BEARD_D3_OP(aux3[i] = Jr3x1[off + i] * S13[off + i] +
                            Jr3x2[off + i] * S23[off + i] +
      ...
      for (bfam_locidx_t j = 0; j < N + 1; j++)
        for (bfam_locidx_t i = 0; i < N + 1; i++, n++)
        {
          ...
          dS11[nid] -=
              wi_ijk * JI[nid] *
              (+M_l *
                   BEARD_D3_AP(Jr1x1[nid] * Dr1Tv1[n] + Jr2x1[nid] * Dr2Tv1[n],
                               +Jr3x1[nid] * Dr3Tv1[n]) +
               lam_l *
                   BEARD_D3_AP(Jr1x2[nid] * Dr1Tv2[n] + Jr2x2[nid] * Dr2Tv2[n],
                               +Jr3x2[nid] * Dr3Tv2[n])
#if DIM == 3
               +
               lam_l *
                   BEARD_D3_AP(Jr1x3[nid] * Dr1Tv3[n] + Jr2x3[nid] * Dr2Tv3[n],
                               +Jr3x3[nid] * Dr3Tv3[n])
#endif
               );
          ...
          dS12[nid] -=
              wi_ijk * JI[nid] *
              (+mu_l *
                   BEARD_D3_AP(Jr1x1[nid] * Dr1Tv2[n] + Jr2x1[nid] * Dr2Tv2[n],
                               +Jr3x1[nid] * Dr3Tv2[n]) +
               mu_l *
                   BEARD_D3_AP(Jr1x2[nid] * Dr1Tv1[n] + Jr2x2[nid] * Dr2Tv1[n],
                               +Jr3x2[nid] * Dr3Tv1[n]));

          dS13[nid] -=
              wi_ijk * JI[nid] *
              (+mu_l *
                   BEARD_D3_AP(Jr1x1[nid] * Dr1Tv3[n] + Jr2x1[nid] * Dr2Tv3[n],
                               +Jr3x1[nid] * Dr3Tv3[n])
#if DIM == 3
               +
               mu_l *
                   BEARD_D3_AP(Jr1x3[nid] * Dr1Tv1[n] + Jr2x3[nid] * Dr2Tv1[n],
                               +Jr3x3[nid] * Dr3Tv1[n])
#endif
               );
          ...
          dS23[nid] -=
              wi_ijk * JI[nid] *
              (+mu_l *
                   BEARD_D3_AP(Jr1x2[nid] * Dr1Tv3[n] + Jr2x2[nid] * Dr2Tv3[n],
                               +Jr3x2[nid] * Dr3Tv3[n])
#if DIM == 3
               +
               mu_l *
                   BEARD_D3_AP(Jr1x3[nid] * Dr1Tv2[n] + Jr2x3[nid] * Dr2Tv2[n],
                               +Jr3x3[nid] * Dr3Tv2[n])
#endif
               );
        }
    ...
    for (bfam_locidx_t face = 0; face < Nfaces; face++)
    {
      for (bfam_locidx_t pnt = 0; pnt < Nfp; pnt++)
      {
        ...
        const bfam_real_t TnP =
            BEARD_D3_AP(TpP[0] * nP[0] + TpP[1] * nP[1], +TpP[2] * nP[2]);
        TpP[0] = TpP[0] - TnP * nP[0];
        TpP[1] = TpP[1] - TnP * nP[1];
        BEARD_D3_OP(TpP[2] = TpP[2] - TnP * nP[2]);

        bfam_real_t vpP[] = {v1[iP], v2[iP], v3[iP]};
        const bfam_real_t vnP =
            BEARD_D3_AP(nP[0] * vpP[0] + nP[1] * vpP[1], +nP[2] * vpP[2]);
        ...
        BEARD_STATE(&TnS, TpS, &vnS, vpS, TnM, TnP, TpM, TpP, vnM, vnP, vpM,
                    vpP, ZpM, ZpP, ZsM, ZsP);
        ...
        /* intra */
        beard_dgx_add_flux(1, TnS, TpS, vnS, vpS, iM, dv1, dv2, dv3, dS11, dS22,
                           dS33, dS12, dS13, dS23, lam[iM], mu[iM], rhoi[iM],
                           nM, sJ[f], JI[iM], wi[0]);
      }
    }
  }
...
void beard_dgx_intra_rhs_sponge(int inN, bfam_subdomain_dgx_t *sub,
                                const char *rate_prefix,
                                const char *field_prefix,
                                const bfam_long_real_t t)
{
...
void beard_dgx_scale_rates_interface(int inN, bfam_subdomain_dgx_t *sub,
                                     const char *rate_prefix,
                                     ...
                                     const char **f_names)
{
  ...
  const bfam_locidx_t num_pts = sub->K * Nfp;
  bfam_dictionary_t *fields = &sub->base.fields;
  beard_dgx_scale_rates(inN, sub, rate_prefix, in_a, fields, f_names, NULL,
                        NULL, num_pts);
}

void beard_dgx_scale_rates_elastic(int inN, bfam_subdomain_dgx_t *sub,
                                   const char *rate_prefix,
                                   const bfam_long_real_t in_a)
{
  ...
  bfam_dictionary_t *fields = &sub->base.fields;
  const char *f_names[] = {"v1",  "v2",  "v3",  "S11", "S22",
                           "S33", "S12", "S13", "S23", NULL};
  beard_dgx_scale_rates(inN, sub, rate_prefix, in_a, fields, f_names, NULL,
                        NULL, num_pts);
}

void beard_dgx_scale_rates(int inN, bfam_subdomain_dgx_t *sub,
                           const char *rate_prefix, const bfam_long_real_t in_a,
                           bfam_dictionary_t *fields, const char **scalars,
                           const char **vectors, const char **tensors,
                           const bfam_locidx_t num_pts)
{
  ...
  if (scalars)
  {
    for (int s = 0; scalars[s] != NULL; s++)
    {
      ...
      for (bfam_locidx_t n = 0; n < num_pts; n++)
        rate[n] *= a;
    }
  }
...
void beard_dgx_add_rates_interface(int inN, bfam_subdomain_dgx_t *sub,
...
void beard_dgx_add_rates_elastic(int inN, bfam_subdomain_dgx_t *sub,
                                 const char *field_prefix_lhs,
                                 const char *field_prefix_rhs,
                                 const char *rate_prefix,
                                 const bfam_long_real_t in_a)
...
void beard_dgx_add_rates_glue_p(int inN, bfam_subdomain_dgx_t *sub,
                                const char *field_prefix_lhs,
                                const char *field_prefix_rhs,
                                const char *rate_prefix,
                                const bfam_long_real_t in_a,
...
void beard_dgx_add_rates(int inN, bfam_subdomain_dgx_t *sub,
                         const char *field_prefix_lhs,
                         const char *field_prefix_rhs, const char *rate_prefix,
                         const bfam_long_real_t in_a, bfam_dictionary_t *fields,
                         const char **scalars, const char **vectors,
                         const char **tensors, const bfam_locidx_t num_pts)
{
  GENERIC_INIT(inN, beard_dgx_glue_p);
  const bfam_real_t a = (bfam_real_t)in_a;
                                  ...
                                  beard_user_bc_t user_bc_func, void *user_data)
{
  ...
  for (bfam_locidx_t le = 0; le < sub_g->K; le++)
  {
    ...
    beard_dgx_remove_flux(N, face, e, sub_m->vmapM, n1, n2,
#if DIM == 3
                          n3,
#endif
                          Zs, Zp, mu, rhoi, lam, sJ, JI, wi, v1, v2, v3, S11,
...
void beard_dgx_inter_rhs_interface(int inN, bfam_subdomain_dgx_t *sub_g,
                                   const char *rate_prefix,
                                   const char *field_prefix,
                                   const bfam_long_real_t t)
{
...
#define N NORDER
    ...
    for (bfam_locidx_t pnt = 0; pnt < Np_g; pnt++)
    {
      ...
      BEARD_STATE(&TnS_g[pnt], &TpS_g[3 * pnt], &vnS_g[pnt], &vpS_g[3 * pnt],
    ...
    /* locked */
    {
      ...
      if (MASSPROJECTION &&
          (!glue_p->same_order || glue_p->EToHm[le] || glue_p->EToHp[le]))
      {
...
#elif DIM == 3
        const int I1 =
            (glue_p->EToHm[le] == 0) ? 0 : (glue_p->EToHm[le] - 1) / 2 + 1;
        const int I2 =
            (glue_p->EToHm[le] == 0) ? 0 : (glue_p->EToHm[le] - 1) % 2 + 1;
...
#error "Bad Dimension"
#endif
        beard_massproject_flux(TnS_M, TpS_M, vnS_M, vpS_M, N, Nrp_g, TnS_g,
                               TpS_g, vnS_g, vpS_g, MP1,
#if DIM == 3
                               MP2,
#endif
                               wi);
...
#error "Bad Dimension"
    ...
    for (bfam_locidx_t pnt = 0; pnt < Nfp; pnt++)
    {
      ...
      beard_dgx_add_flux(1, TnS_M[pnt], &TpS_M[3 * pnt], vnS_M[pnt],
                         &vpS_M[3 * pnt], iM, dv1, dv2, dv3, dS11, dS22, dS33,
                         dS12, dS13, dS23, lam[iM], mu[iM], rhoi[iM], nM, sJ[f],
                         JI[iM], wi[0]);
    }
  }
}

void beard_dgx_inter_rhs_slip_weakening_interface(int inN,
...
#error "invalid DIM"
      ...
      if (T0[iG] > 0)
        f_val = BFAM_MAX(
            f_val, BFAM_MIN(BFAM_MAX((bfam_real_t)(t - T[iG]) / T0[iG], 0), 1));
      /* END SCEC */
 ...
 */
      ...
      if (user_bc_func)
      {
        ...
        bfam_real_t Vs = 0;
        bfam_real_t Tps = 0;
        bfam_real_t Tns = exact_TnM + Tn_0[iG] + pf_0[iG];
        for (bfam_locidx_t n = 0; n < 3; n++)
        {
        ...
        psi[iG] = BFAM_REAL_LOG((2 * V0[iG] / Vs) *
                                BFAM_REAL_SINH(Tps / (-a[iG] * Tns)));
    ...
    for (bfam_locidx_t k = 0; k < N + 1; k++)
    {
      ...
      for (bfam_locidx_t j = 0; j < N + 1; j++)
      {
        ...
        for (bfam_locidx_t i = 0; i < N + 1; i++, n++)
        {
          ...
          energy_sq[0] +=
              BEARD_D3_AP(wi * wj, *wk) * J[n] *
              (rho[n] * (v1[n] * v1[n] + v2[n] * v2[n] + v3[n] * v3[n]) / 2 +
               (s11 * s11 + s22 * s22 + s33 * s33 + 2 * s12 * s12 +
                2 * s13 * s13 + 2 * s23 * s23) /
                   (4 * mu[n]) +
